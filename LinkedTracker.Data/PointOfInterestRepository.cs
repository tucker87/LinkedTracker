    ...
    public PointOfInterestRepository()
    {
        _poiGenerators = new Dictionary<(string, string), Func<List<PointOfInterest>>>
        {
            [("lttp", "Randomizer")] = () => new List<PointOfInterest> {
                new("Pedestal", 18, 20, new Area("Pedestal")),
                new("Lost Woods", 70, 50, new Area("Shroom"), new Area("Hideout")),
                new("Lumberjack Cave", 139, 21, new Area("Cave")),
                new("The Well", 20, 180, new Area("Cave", 4), new Area("Bomb")),
                new("Blind's House", 65, 180, new Area("Main", 4), new Area("Bomb")),
                ...
                new("Tower of Hera", 246, 18, new Area("Dungeon", 2)),
                ...
                new("Paradox Cave", 378, 64, new Area("Top", 2), new Area("Bottom", 5)),
                //Also Paradox cave somehow... 381, 95
                new("Waterfall Fairy", 396, 66,new Area("Waterfall Cave", 2)),
                ...
                new("Sahasrala's Hut", 358, 200, new Area("Back Room", 3), new Area("Shabadoo")),
                new("Eastern Palace", 423, 172, new Area("Dungeon", 3)),
                ...
                new("Desert Palace", 32, 354, new Area("Dungeon", 2)),
                ...
                new("Mini Moldorm Cave", 288, 414, new Area("Cave", 5)),
